...
import 'package:freshlii_store_trial_2/screens/dashboard/goOnlinePage.dart';
import 'package:freshlii_store_trial_2/screens/dashboard/landingPage.dart';
import 'package:freshlii_store_trial_2/screens/login/preLoginVerification.dart';
      ...
      child: ListView(
        children: <Widget>[
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(isOnline ? "Status: Online" : "Status: Offline", textAlign: TextAlign.left,style: TextStyle(
          ...
          InkWell(
            ...
            onTap: () {
              changeScreenPushReplacement(context, LandingPage());
            },
          ),
          InkWell(
            child: ListTile(
          ...
          InkWell(
            ...
            onTap: () {
              changeScreenPush(context, ActiveOrderScreen());
            },
          ),
          InkWell(
            child: ListTile(
